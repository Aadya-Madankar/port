    ...
    <div>
      ...
      <section className="container pb-20 pt-8 md:pt-16 reveal">
        <div className="flex items-start justify-between gap-6">
          ...
          >
            <motion.h1
              className="text-[14vw] leading-[0.9] md:text-[8rem] font-semibold tracking-tight select-none"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="hidden md:flex flex-col items-end gap-6 pt-4"
          ...
          >
            ...
            <div className="relative">
              <motion.div
                className="size-28 rounded-full border border-border grid place-items-center"
                initial={{ scale: 0.98 }}
                animate={{ scale: 1 }}
      ...
      <section id="ai-associate" className="container py-16 md:py-20 reveal">
        <div className="flex flex-col md:flex-row items-start gap-8 md:gap-12">
          ...
          >
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm">
              {["Agents", "RAG", "Tool Use", "Evaluation", "Web UI"].map(
                (t) => (
                  <span
                    key={t}
            ...
            <div className="mt-6 flex gap-3">
              <a
                href="https://ai-associate-2025.vercel.app/"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center rounded-full bg-primary text-primary-foreground px-5 py-2.5 text-sm"
              >
                Live Demo
              </a>
              <a
                href="https://github.com/Aadya-Madankar/AI-Associate-2025"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center rounded-full border border-border px-5 py-2.5 text-sm hover:bg-primary hover:text-primary-foreground"
              >
                GitHub
              </a>
            </div>
          ...
          <motion.a
            ...
            target="_blank"
            rel="noreferrer"
            className="group md:w-3/5 relative overflow-hidden rounded-2xl border border-border"
          ...
          >
            <img
              alt="AI Associate preview"
              src="https://opengraph.githubassets.com/1/Aadya-Madankar/AI-Associate-2025"
